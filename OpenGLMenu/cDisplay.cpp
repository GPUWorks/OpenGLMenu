...
Display::Display(unsigned int winWidth, unsigned int winHeight, int vpWinPosx, int vpWinPosy, int vpWidth, int vpHeight, const char * title, MouseHM &dmouse)
{
	glfwInit();
	...
	glViewport(vpWinPosx, vpWinPosy, vpWidth, vpHeight);
